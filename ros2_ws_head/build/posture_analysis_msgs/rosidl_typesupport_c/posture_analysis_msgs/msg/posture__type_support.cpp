...
static const _Posture_type_support_symbol_names_t _Posture_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, posture_analysis_msgs, msg, Posture)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, posture_analysis_msgs, msg, Posture)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, posture_analysis_msgs, msg, Posture)() {
  return &::posture_analysis_msgs::msg::rosidl_typesupport_c::Posture_message_type_support_handle;
}
